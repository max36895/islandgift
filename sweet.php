    ...
    <div id="ul-content">
                ...
                <div id="ul-id-7-7" class="row ul-row">
                    <div id="ul-id-7-8" class="col ul-col col-xs-12 col-sm-12 col-md-12">
                        <div id="ul-id-7-9" spellcheck="false" class="ul-widget ul-widget-wysivig-header" data-controls="mer" data-tag="h1" data-widget="header">
                            <div spellcheck="false"><div class="ul-header-editor clearfix ul-header-wrap" style="outline:0;word-wrap:break-word;margin:0 5px"><h1 class="ul-w-header-span h1" style="text-align:center"><?=$pageText['sweet']['title']?></h1></div></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container js-block-container">
                <div id="ul-id-5-1" class="row ul-row">
                    <div id="ul-id-5-2" class="col ul-col col-xs-12 col-sm-12 col-md-12">
                        <div id="ul-id-5-3" class="ul-widget ul-widget-wysivig" data-image="true" data-controls="mer" data-widget="wysiwyg"><div class="ul-wysivig-editor clearfix" style="outline:0;word-wrap:break-word"><p><?=$pageText['sweet']['description']?></p></div></div>
                    </div>
                </div>
            </div>
        </div>
        <div id="ul-id-5-4" class="ul-container g-theme-block-0 g-theme-block-2" data-theme="g-theme-block-0" data-parallax="none" style="" data-bgtype="color" data-map-settings="" data-auto_height="true" data-is-100vh-enabled="false" data-behavior="none">
            <div class="container-fluid js-block-container" id="productOrder">
                ...
                <div id="ul-id-5-8" class="row ul-row"><div id="ul-id-5-9" class="col ul-col col-xs-12 col-sm-12 col-md-12"><div id="ul-id-5-10" class="ul-widget" type="border"><div class="ul-w-border" data-reactroot="" data-reactid="1" data-react-checksum="2056334462"><div class="hr ul-widget-border-style2" data-reactid="2"></div></div></div></div></div>
                <div id="ul-id-5-11" class="row ul-row">
                    <div id="ul-id-5-12" class="col ul-col col-xs-12 col-sm-12 col-md-12">
                        <?php
                        $color = 'style="color:';
                        ...
                        ?>
                        <div id="ul-id-5-13" class="ul-widget ul-w-spacer" data-controls="mer" style="height:50px" data-widget="spacer"></div>
                    </div>
                </div>
                <?php $site->findProductText(7); ?>
